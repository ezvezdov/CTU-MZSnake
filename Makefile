...
SOURCES = main.c mzapo_phys.c mzapo_parlcd.c serialize_lock.c snake.h snake.c text_print.h text_print.c screen_data.h options.h options.c apple.c apple.h board.c board.h 
